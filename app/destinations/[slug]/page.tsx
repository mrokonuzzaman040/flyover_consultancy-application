...
async function getDestination(slug: string) {
  try {
    ...
    const destination = data.destinations?.find((dest: { slug: string }) => dest.slug === slug);
    return destination;
  } catch (error) {
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            <Reveal delay={0.1}>
              <div className="bg-white rounded-lg p-4 text-center shadow-sm">
                ...
                <div className="font-semibold text-gray-900 text-sm">{destination.universities}</div>
              </div>
            </Reveal>
            <Reveal delay={0.2}>
              <div className="bg-white rounded-lg p-4 text-center shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            <Reveal delay={0.1}>
              <div className="bg-white rounded-lg p-6 shadow-lg text-center">
                <div className="text-2xl font-bold text-brand-600 mb-2">{destination.universities}</div>
      ...
      <section className="py-16 bg-gradient-to-r from-brand-50 to-brand-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {/* Sample universities - in a real app, this would come from the database */}
              ...
              <>
                <Reveal delay={0.1}>
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div className="relative h-48 overflow-hidden">
                      <UniversityImage
                        src="https://images.unsplash.com/photo-1562774053-701939374585?w=400&h=300&fit=crop&crop=entropy&auto=format&q=80"
                ...
                <Reveal delay={0.2}>
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div className="relative h-48 overflow-hidden">
                      <UniversityImage
                        src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=400&h=300&fit=crop&crop=entropy&auto=format&q=80"
                ...
                <Reveal delay={0.3}>
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div className="relative h-48 overflow-hidden">
                      <UniversityImage
                        src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=400&h=300&fit=crop&crop=entropy&auto=format&q=80"
                        alt="Australian National University campus"
                        className="group-hover:scale-105 transition-transform duration-300"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent z-10" />
                      <div className="absolute top-4 right-4 z-20">
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Australian National University</h3>
                      <div className="flex items-center text-sm text-gray-500 mb-3">
                        <MapPin className="w-4 h-4 mr-1 flex-shrink-0" />
                        <span>Canberra</span>
                      </div>
              ...
              <>
                <Reveal delay={0.1}>
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Harvard University</h3>
                      <div className="flex items-center text-sm text-gray-500 mb-3">
                        <MapPin className="w-4 h-4 mr-1 flex-shrink-0" />
                ...
                <Reveal delay={0.2}>
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <div className="relative h-48 overflow-hidden">
                      <UniversityImage
                        src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=400&h=300&fit=crop&crop=entropy&auto=format&q=80"
                        alt="MIT campus"
                        className="group-hover:scale-105 transition-transform duration-300"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent z-10" />
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-2">MIT</h3>
                      <div className="flex items-center text-sm text-gray-500 mb-3">
                        <MapPin className="w-4 h-4 mr-1 flex-shrink-0" />
                        <span>Cambridge, MA</span>
                      </div>
                ...
                <Reveal delay={0.3}>
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-gray-900 mb-2">Stanford University</h3>
                      <div className="flex items-center text-sm text-gray-500 mb-3">
                        <MapPin className="w-4 h-4 mr-1 flex-shrink-0" />
